...
public class ForgotPasswordViewModel extends ViewModel {
     ...
     * */
    public void hitEmailConfirmation(ResetPassword model) {
        disposables.add(repository.executeSendEmailConfirmation(model)
    ...
    public void hitNewPassword(ResetPassword model) {
        disposables.add(repository.executeNewPassword(model)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnSubscribe((d) -> responseLiveData.setValue(ApiResponse.loading()))
                .subscribe(
