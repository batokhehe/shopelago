...
import com.shopelago.view.fragments.MessageInboxFragment.OnListFragmentInteractionListener;
...
public class MessageInboxAdapter extends RecyclerView.Adapter<MessageInboxAdapter.ViewHolder> {
    ...
    public MessageInboxAdapter(Context context, List<Message> listMessage, OnListFragmentInteractionListener listener) {
        mContext = context;
