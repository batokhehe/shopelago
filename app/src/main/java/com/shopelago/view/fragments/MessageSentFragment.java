...
import com.shopelago.view.adapters.MessageSentAdapter;
...
public class MessageSentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvInbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Fragment fragment = new MessageInboxFragment();
    ...
    private void initListMessage() {
        ...
        MessageSentAdapter adapter = new MessageSentAdapter(getContext(),listMessage, mListener);
